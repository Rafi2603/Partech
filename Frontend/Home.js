...
const Home = ({ navigation }) => {
  ...
  const { userID, username, balance, email, phone, status } = route.params;
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Display different text based on the 'status' value */}
      {status ? (
        <View style={styles.middleSpace}>
          <Text style={styles.middleText}>There is a parked vehicle</Text>
        </View>
      ) : (
        <View style={styles.middleSpace}>
          <Text style={styles.middleText}>No parked vehicle</Text>
        </View>
      )}
      ...
      <View style={styles.topContainer}>
        <View style={styles.bottomNavbar}>
          ...
          {/* Display "Park Now" button only if the status is false */}
          {!status && (
          ...
          <TouchableOpacity style={styles.navButtonBlue} onPress={handleHistory}>
